...
console.log("[botcity.xyz]: Profile/Edit enrutador cargado..");
...
app.post("/:userID/edit", global.checkAuth, async (req, res) => {
    ...
    await profiledata.findOneAndUpdate({
        ...
        $set: {
            biography: rBody['biografia'],
            website: rBody['página web'],
            github: rBody['github'],
    ...
    return res.redirect('?success=true&message=Su perfil ha sido editado con éxito.');
});
