...
console.log("[botcity.xyz]: Admin/CodeShare/Index enrutador cargado");
...
app.get("/admin/editcode/:code", global.checkAuth, async (req, res) => {
    ...
    if (!koddata) return res.redirect('/codes?error=true&message=Ingresaste un código inválido.')
...
app.get("/admin/deletecode/:code", global.checkAuth, async (req, res) => {
    ...
    return res.redirect('/admin/codes?success=true&message=Código eliminado.');
});
